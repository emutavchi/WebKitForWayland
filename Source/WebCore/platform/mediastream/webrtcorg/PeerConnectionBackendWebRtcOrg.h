...
public:
    ...
    void requestSucceeded(int id, Ref<RTCSessionDescription>&& desc);
    void requestSucceeded(int id, const webrtc::StatsReports& reports);
    void requestSucceeded(int id);
    void requestFailed(int id, const std::string& error);
...
class RTCDataChannelHandlerWebRtcOrg : public RTCDataChannelHandler
{
public:
    RTCDataChannelHandlerWebRtcOrg(webrtc::DataChannelInterface* channel);
    ~RTCDataChannelHandlerWebRtcOrg() override;
...
private:
    ...
    class RTCDataChannelObserver : public webrtc::DataChannelObserver, public rtc::RefCountInterface
    {
